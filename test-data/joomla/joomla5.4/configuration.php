...
class JConfig
{
    ...
    public $sitename = 'My Joomla! website';
    // Name of Joomla site
    ...
    public $user = 'jtkdbuser_h6znpb';
    // Database username
    public $password = 'ZYk4x5Fi?N76p20*DThc';
    // Database password
    public $db = 'jtkdb_ouk4cq';
    // Database name
    public $dbprefix = 'iuh0d1wk_';
    // Any random string ending with _
    ...
    public $dbsslcipher = '';
    /* Server Settings */
    public $secret = 'inG6YAR4j1OlNkGo';
    // Use something very secure. For example on linux the following command `cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w ${1:-16} | head -n 1`
    public $gzip = true;
    public $error_reporting = 'none';
    public $helpurl = 'https://help.joomla.org/proxy?keyref=Help{major}{minor}:{keyref}&lang={langcode}';
    public $tmp_path = '/var/www/vhosts/affectionate-jackson.10-66-94-54.qa.plesk.tech/httpdocs/tmp';
    // This path needs to be writable by Joomla!
    public $log_path = '/var/www/vhosts/affectionate-jackson.10-66-94-54.qa.plesk.tech/httpdocs/administrator/logs';
    // This path needs to be writable by Joomla!
    public $live_site = '';
    // Optional, full URL to Joomla install eg https://www.example.com
    public $force_ssl = 0;
    // Force areas of the site to be SSL ONLY.  0 = None, 1 = Administrator, 2 = Both Site and Administrator
    /* Locale Settings */
    public $offset = 'UTC';
    /* Session settings */
    public $lifetime = 600;
