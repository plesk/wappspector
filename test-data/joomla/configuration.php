...
class JConfig
{
    ...
    public $user = 'jtkdbuser_yj3m9a';
    // Database username
    public $password = 'F0uj*5g@BPUiT3E94wr8';
    // Database password
    public $db = 'jtkdb_jzexoa';
    // Database name
    public $dbprefix = 'm4qcgoka_';
    ...
    public $dbsslcipher = '';
    /* Server Settings */
    public $secret = 'qU2mbaotvdWwRpxF';
    ...
    public $tmp_path = '/var/www/vhosts/goofy-mayer.157-90-100-150.plesk.page/httpdocs/tmp';
    // This path needs to be writable by Joomla!
    public $log_path = '/var/www/vhosts/goofy-mayer.157-90-100-150.plesk.page/httpdocs/administrator/logs';
    // This path needs to be writable by Joomla!
    public $live_site = '';
